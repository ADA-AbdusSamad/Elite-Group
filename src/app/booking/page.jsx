                ...
                <div className={`${styles['booking-container']} container`}>
                    <div className={styles.divItem1}>
                        <div className='text-center'>
                            ...
                            <p className='pt-3'>Thank you for your interest in our services. Please fill out the form below, and we'll get in touch with you shortly to schedule a meeting.</p>
