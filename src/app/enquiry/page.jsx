...
import styles from '../enquiry/page.module.css'
                    ...
                    <div className={styles.divItem1}>
                        <div className='text-center'>
                            ...
                            <div className={styles['input-flex']}>
                                <input type='text' placeholder='First Name*' className={styles['name-input']}></input>
                                <input placeholder='Last Name*' className={styles['name-input']}></input>
                            </div>
