    ...
    <div>
      <section className={styles['menu-section']}>
        <div className={`${styles["menu-container"]} container`}>
            ...
            <div>
              <div className='pb-5'>
                <div className={styles['svg-div']}>
                  <svg xmlns="http://www.w3.org/2000/svg" version="1.0" width="5rem" height="36.000000pt" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
          ...
          <div className={styles['menu-div2']}>
                ...
                <div className="tab-content">
                  <div id="special" className={`${styles["menu-list"]} tab-pane active`} role="tabpanel">
                    ...
                    <div className={styles['menu-list-wrap']}>
                      <div className='name'>
                        <h1 className='text-center'>Avant Heritage V</h1>
                      </div>
                    </div>
